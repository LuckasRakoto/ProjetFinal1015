...
public:
	explicit Piece(std::pair<int, int> position, char piece, char color) : position_(position), piece_(piece), color_(color) {}; //Constructeur; prk explicit? -> on veut pas de conversion pas explicite
